...
import core.Core_DB_Set_Frist_Time;
 ...
 * @version 1.6
 */
public class DB_Set_Frist_Time extends javax.swing.JFrame 
{
    private Core_DB_Set_Frist_Time core;
    public DB_Set_Frist_Time() 
    {
        this.setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/res/srch_24.png")));
        initComponents();
        
        core = new Core_DB_Set_Frist_Time(this);
        core.setDBAdress();
